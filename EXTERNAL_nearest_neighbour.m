function [idx, tri] = EXTERNAL_nearest_neighbour(varargin)
% Proprietary function applied in the AJSABQ Input
% File Generator Version 2.0 to determine the closest node
% coordinate to those already in existance
% 
